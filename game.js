...
const levels = [
    ...
    { title: "6. ทะเลสาบสงขลา", desc: "จงหา <b>'ทะเลสาบที่ใหญ่ที่สุด'</b> ในประเทศไทย (ภาคใต้)", hints: ["มองหาแหล่งน้ำขนาดใหญ่ใกล้หาดใหญ่", "ซูมดูแผนที่ถนนจะเห็นชื่อชัดเจน"], target: [7.450, 100.300], radius: 40000, zoom: 9, center: [7.20, 100.40] },
